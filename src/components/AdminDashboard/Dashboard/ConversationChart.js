...
const ConversationChart = () => {
  ...
  const months = dashboardData.data.monthly_conversation_chart.map((item) => item.month);
  const counts = dashboardData.data.monthly_conversation_chart.map((item) => item.count);
